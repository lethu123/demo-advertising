...
const page = () => {
    return (
        <Screen>
            <HeaderComponent />
            {/* BANNER */}
            <BannerSingle classImage={'bg-banner-product1'} />

            <div className='mt-auto py-4' style={{ background: '#F99E1D' }}>
                <Image className='mx-auto' width={88} height={53} alt='' src={sloganIcon} />
                <h3 className='text-white text-center mt-5 text-2xl lg:text-[37.12px] font-avo_bold'>THIẾT KẾ SẢN XUẤT BAO BÌ GIẤY</h3>
            </div>
