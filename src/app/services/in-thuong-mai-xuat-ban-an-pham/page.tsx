    ...
    return (
        <Screen>
            ...
            <div className='mt-auto py-4' style={{ background: '#F99E1D' }}>
                ...
                <h3 className='text-white text-center mt-5 text-2xl lg:text-[37.12px] font-avo_bold'>IN THƯƠNG MẠI, XUẤT BẢN PHẨM</h3>
            </div>
                ...
                <Container>
                    ...
                    <div className='relative mt-28'>
                        ...
                        <div className=' grid grid-cols-4 gap-1 items-stretch'>
                            ...
                            <div className='col-span-2 sm:col-span-2 md:col-span-1 mb-3'>
                                <Image alt='' className={`h-full w-full ${styles.image_hover} `} src={sp17} />
                            </div>
                            <div className='col-span-2 sm:col-span-2 md:col-span-1 mb-3'>
                                <Image alt='' className={`h-full w-full ${styles.image_hover} `} src={sp18} />
                            </div>
                            <div className='col-span-2 sm:col-span-2 md:col-span-1'>
                                <Image alt='' className={`h-full w-full ${styles.image_hover} `} src={sp19} />
                            </div>
                        </div>
            ...
            <div className='pt-8 pb-14 relative overflow-hidden' style={{ background: '#F99E1D', zIndex:-1 }} >
                <Container >
                    <div className='mb-5  py-4' style={{ background: '#F99E1D' }}>
                        <Image className='mx-auto' width={88} height={53} alt='' src={sloganIcon} />
                        <h3 className='text-white text-center mt-5 text-2xl lg:text-[37.12px] font-avo_bold leading-snug'>THIẾT KẾ THI CÔNG PANO, <br />
                            HỘP ĐÈN QUẢNG CÁO</h3>
                    </div>
                    <div className='col-span-2 md:col-span-1  grid grid-cols-2 gap-1'>
                        <div className='col-span-1'>
                            <Image alt='' className={`h-full w-full ${styles.image_hover} `} src={sp20} />
                        </div>
                        <div className='col-span-1'>
                            <Image alt='' className={`h-full w-full ${styles.image_hover} `} src={sp21} />
                        </div>
                        <div className='col-span-1'>
                            <Image alt='' className={`h-full w-full ${styles.image_hover} `} src={sp22} />
                        </div>
                        <div className='col-span-1'>
                            <Image alt='' className={`h-full w-full ${styles.image_hover} `} src={sp23} />
                        </div>
                    </div>
                    <div className='text-white py-8'>
                        <p className='mb-2'>
                            - Pano, hộp đèn quảng cáo là một hình thức quảng cáo truyền thống mà các doanh nghiệp lớn ưu tiên chọn để định vị sản phẩm của mình trên thị trường. Pano thường là những biển quảng cáo có kích thước to, được đặt ở các vị trí cao như ở trên các cao tốc, các nút giao nhau để có thể thu hút được sự chú ý của người đi đường.
                        </p>
                        <p className='mb-2'>
                            - Chịu được nhiệt, mưa nắng, các điều kiện thời tiết khắc nghiệt, có sự dẻo dai, bám tốt. Để thỏa được các điều kiện trên thì chúng tôi chọn in trên Hiflex cao cấp – là loại nhựa cao cấp Polyvinyclorua cùng với công nghệ in phun kỹ thuật số hiện đại giúp sẽ giúp màu bám tốt, hình ảnh, màu sắc vô cùng chân thực.
                        </p>
                        <p>
                            M.A.I có dội ngũ thiết kế pano theo yêu cầu của khách hàng. Nhận thi công trọn gói và lắp đặt toàn quốc. Dựa trên nhu cầu thực tế mà khách mong muốn cty M.A.I sẽ tư vấn phù hợp nhất.
                        </p>
                    </div>
                </Container>
