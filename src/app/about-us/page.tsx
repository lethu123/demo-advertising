                ...
                <Container>
                    <div className='xl:pt-16 pb-16'>
                        <div className='flex gap-8 mb-8 xl:mb-14 justify-center lg:justify-start'>
                            ...
                            <h1 className=' font-icie_medium text-xl md:text-[40px] lg:text-[50px] mt-5 text-[#534741] tracking-[0.5rem]'>VỀ CHÚNG TÔI</h1>
                        </div>
                        <div>
                            <p className='mb-2 text-[#534741]'>Được thành lập năm 2015 với tên gọi là Công ty TNHH Quảng Cáo và Phát Triển M.A.I (M.A.I Development And Advertising Company Limited). </p>
