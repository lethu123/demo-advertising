            ...
            <div className="">
                ...
                <div className="w-full xl:w-4/6 max-w-screen-lg justify-center mx-auto px-4 xl:px-0">
                    <div className='xl:pt-16 pb-16'>
                        ...
                        <div>
                            <p className='mb-2 text-xl md:text-[36px] text-[#534741]'>Được thành lập năm 2015 với tên gọi là <b> Công ty TNHH Quảng Cáo và Phát Triển M.A.I </b>  (M.A.I Development And Advertising Company Limited). </p>
                            <p className='text-xl md:text-[36px] text-[#534741]'>
