            ...
            <Container >
                <div className='flex lg:justify-around justify-between items-center py-[9px] flex-wrap' >
                    <div className='items-center hidden lg:flex'>
                        ...
                        <span className="text-[#2E3A40] ml-2 text-[16.5px]">60 Đào Duy Anh, P.9, Q. Phú Nhuận, TP. Hồ Chí Minh </span>
                    </div>
                    <div className='flex items-center'>
                        <Image style={{ width: 20, height: 20 }} alt='' src={icPhone} />
                        <span className="text-[#2E3A40] ml-2 text-xs sm:text-sm text-[16.5px]"> (+84) 28 2240 6511</span>
                    </div>
