...
const ProductComponent = () => {
    return (
        <Container>
            <div>
                <h1 className='text-center text-[35.03px] font-avo_bold'>
                    SẢN PHẨM CỦA CHÚNG TÔI
                </h1>
                <h3 className='text-center text-[27.88px] font-icie_medium tracking-[0.15rem] my-8'>THIẾT KẾ - SÁNG TẠO – IN ẤN</h3>
                ...
                <h3 className='text-center text-[27.88px] font-icie_medium tracking-[0.15rem] my-8'>THI CÔNG, THIẾT KẾ, CHO THUÊ <br /> BẢNG HIỆU TRONG NHÀ & PANO NGOÀI TRỜI</h3>
                ...
                <h3 className='text-center text-[27.88px] font-icie_medium tracking-[0.15rem] my-8'>SẢN XUẤT VẬT PHẨM – THIẾT BỊ QUẢNG CÁO <br /> IN PHUN KỸ THUẬT SỐ</h3>
                <div className='grid grid-cols-2 gap-10'>
