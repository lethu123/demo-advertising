      ...
      <div className='w-full px-3 xl:w-5/6 max-w-screen-xl lg:mx-auto'>
        <div className="grid grid-cols-5 gap-10 xl:gap-16   items-stretch flex-wrap">
          <div className="col-span-5 lg:col-span-2">
            <h1 className="text-orange1 text-xl font-extrabold font-avo_bold lg:text-[20px] mb-2">Công ty TNHH Quảng Cáo và <br className='hidden lg:block 2xl:hidden' /> Phát Triển M.A.I</h1>
            ...
            <div className='hidden lg:block'>
              <div className="flex custom-text-mode gap-2 items-start mb-1">
                <IconLocation color='white' className='w-[15px] custom-icon-show mt-1' />
                <span className=' font-avo flex-1'>60 Đào Duy Anh, Phường 9, Q. Phú Nhuận, TP HCM</span>
              </div>
              <div className="flex flex-wrap gap-10 lg:gap-0 lg:justify-between">
                <div className="flex custom-text-mode gap-2">
                  <IconPhone color='white' className='w-[15px] custom-icon-show' />
          ...
          <div className='col-span-5 lg:col-span-3'>
            <div className='md:flex xl:flex col-span-3 flex-wrap grid grid-cols-2 lg:grid lg:grid-cols-4 md:flex-nowrap  xl:flex-nowrap gap-10'>
              <div className="col-span-2 sm:col-span-1 lg:col-span-2 xl:grow ">
                <h1 className="custom-text-mode font-extrabold text-[20px]">Sản phẩm</h1>
                <ul className={`${styles.ul} custom-text-mode`}>
                  ...
                  <li className=' flex gap-2 menu-footer'>
                    ...
                    <Link href="/products/standee-backrop-pp-hiflex" > Standee, backrop (PP, hiflex)</Link>
                  </li>
                </ul>
              </div>
                ...
                <div>
                  ...
                  <ul className={`${styles.ul} custom-text-mode`}>
                    ...
                    <li className=' flex gap-2 menu-footer'>
                      ...
                      <Link href={'/services/thiet-ke-trung-bay-quang-cao'} >Thiết kế trưng bày quảng cáo (POSM)</Link>
                    </li>
                    <li className=' flex gap-2 menu-footer'>
                      <div>
                        <i className="fa fa-angle-right"></i>
                      </div>
                      <Link href={'/services/in-thuong-mai-xuat-ban-an-pham'} >In thương mại, xuất bản phẩm</Link>
                    </li>
                    <li className=' flex gap-2 menu-footer'>
                      <div>
                        <i className="fa fa-angle-right"></i>
                      </div>
                      <Link href={'/services/thiet-ke-thi-cong-pano-hop-den-quang-cao'} >Thiết kế thi công pano, hộp đèn quảng cáo</Link>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div>
                  ...
                  <ul className={`${styles.ul} custom-text-mode`}>
                    <li className=' flex gap-2 menu-footer'>
                      ...
                      <Link href={'/'} className='text-nowrap'>Form liên hệ</Link>
                    </li>
                    <li className=' flex gap-2 menu-footer'>
                      <div>
                        <i className="fa fa-angle-right"></i>
